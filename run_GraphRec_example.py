...
def train(model, device, train_loader, optimizer, epoch, best_rmse, best_mae):
    ...
    for i, data in enumerate(train_loader, 0):
        ...
        if i % 10 == 0:
            ...
            print(time.strftime("%H:%M:%S", time.localtime()),' [%d, %5d] loss: %.3f, The best rmse/mae: %.6f / %.6f' % (
...
def main():
    ...
    parser.add_argument('--data', type=str, default='data/CiaoDVD', metavar='N', help='number of epochs to train')    

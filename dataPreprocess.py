...
class dataPreprocess(object):
    ...
    def __init__(self, filepath,userItemDict= {},userRatings= {},itemUserDict= {},itemRatings= {},trainUsers= [],trainItems= [],trainRatings= [] ,testUsers= []   ,testItems= []  ,testRatings= [] ,userUserDict= {} ,ratingsL= {} ,user= [] ,friend= []  ,trust= []):
        '''
        Description:
            Initialization/Constructor function
        '''
        self.filepath = filepath
        self.userItemDict= userItemDict
        self.userRatings= userRatings
        self.itemUserDict= itemUserDict
        ...
        self.userUserDict= userUserDict
        self.ratingsL= ratingsL
        self.user= user
        self.friend= friend
        self.trust= trust
    ...
    def preprocess(self):
        ...
        # print('userItemDict',userItemDict)
        # print('userRatings',userRatings)
        # print('itemUserDict',itemUserDict)
        # print('itemRatings',itemRatings)
        # print('trainUsers',trainUsers)
        # print('trainItems',trainItems)
        # print('trainRatings',trainRatings)
        # print('testUsers',testUsers)
        # print('testItems',testItems)
        # print('testRatings',testRatings)
        # print('userUserDict',userUserDict)
        # print('ratingsL',ratingsL)
        # print('user',user)
        # print('friend',friend)
        # print('trust',trust)
